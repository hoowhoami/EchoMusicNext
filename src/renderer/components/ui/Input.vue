...
<template>
  <div :class="['relative group w-full', props.class]">
    <input
      ...
      :class="[
        'w-full h-14 pl-6 pr-12 bg-black/[0.03] dark:bg-white/[0.03] border border-transparent focus:border-primary/30 focus:bg-transparent rounded-2xl outline-none transition-all font-medium text-[15px] placeholder:opacity-50',
        props.inputClass
      ]"
    />
