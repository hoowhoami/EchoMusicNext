  ...
  <header class="title-bar drag flex items-center px-6 shrink-0 select-none transition-colors duration-300 z-[100] bg-transparent">
    ...
    <div class="flex items-center gap-1 no-drag">
      <button @click="goBack" class="nav-btn group" title="后退">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" class="text-text-main opacity-40 group-hover:opacity-100 transition-opacity"><path d="m15 18-6-6 6-6"/></svg>
      </button>
      <button @click="goForward" class="nav-btn group" title="前进">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" class="text-text-main opacity-40 group-hover:opacity-100 transition-opacity"><path d="m9 18 6-6-6-6"/></svg>
      </button>
